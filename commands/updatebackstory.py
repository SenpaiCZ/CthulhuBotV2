...
class updatebackstory(commands.Cog):
    ...
    @app_commands.command(name="updatebackstory", description="✍️ Update elements in your character's backstory.")
    async def updatebackstory(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message("Use the **Edit** button to update your backstory.", embed=view.get_embed(), view=view, ephemeral=True)
        finally:
            db.close()
