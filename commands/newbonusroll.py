...
class newbonusroll(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @commands.command(aliases=["NBD", "nbd", "bs"], guild_only=True)
    async def newbonusroll(self, ctx, *, dice_expression):
...
async def setup(bot):
    await bot.add_cog(newbonusroll(bot))
